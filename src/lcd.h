...
#define LCD_RS              P7_bit.no0		// Register select
#define LCD_RW              P7_bit.no1		// Read/Write line
#define LCD_E               P7_bit.no2		// Enable Strobe
#define LCD_D4              P7_bit.no4		// 4 Nibble data lines
#define LCD_D5              P7_bit.no5
#define LCD_D6              P7_bit.no6
#define LCD_D7              P7_bit.no7
